    ...
    <React.Fragment>
      ...
      <div className="">
        <div className="relative h-[450px] md:h-[550px] justify-center mx-auto flex flex-col w-11/12 max-w-maxContent items-center text-white ">
          <div
            className="z-0 group p-1 mx-auto rounded-full bg-richblack-800 font-bold text-richblack-200 mt-[72px]
          ...
          <motion.div
            ...
            className="text-center text-3xl lg:text-4xl font-semibold mt-7 text-white "
          >
          ...
          <motion.div
            ...
            whileInView={"show"}
            viewport={{ once: false, amount: 0.1 }}
            className="mt-4 text-center text-base lg:text-lg font-bold text-richblack-300"
          >
        ...
        <div className="relative mx-auto flex flex-col w-11/12 max-w-maxContent items-center text-white justify-between">
          ...
          <div className=" ml-[-400px]">
            <h2 className="mx-auto box-content w-full max-w-maxContentTab py-12 lg:max-w-maxContent">
