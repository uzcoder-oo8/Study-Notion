...
export default function ExploreMore() {
  const [currentTab, setCurrenTab] = useState(tabsName[0]);
  ...
  return (
    <div>
      <div className="">
        <div className="text-3xl text-white lg:text-4xl font-semibold text-center  my-10">
          Unlock the
     ...
     rounded-full font-medium drop-shadow-[0_1.5px_rgba(255,255,255,0.25)]"
        >
          {tabsName.map((element, index) => {
            return (
              <div
                className={` text-[16px] flex flex-row items-center gap-2 px-7 py-[7px] rounded-full
                ${
                  currentTab === element
      ...
      <div className="hidden lg:block lg:h-[200px]">
        <div
          className="lg:absolute gap-10 justify-center lg:gap-0 flex lg:justify-between flex-wrap w-full lg:bottom-0 lg:left-[50%]
