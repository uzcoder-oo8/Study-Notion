...
export default function Footer() {
  return (
    <div className=" bg-richblack-800 mx-7 rounded-3xl mb-10 ">
      <div
        className=" flex lg:flex-row gap-8 items-center justify-between w-11/12 max-w-maxContent 
     text-richblack-400 leading-6 mx-auto relative py-14  "
      >
        <div className="w-[100%] border-b flex flex-col lg:flex-row pb-5 border-richblack-700 ">
          <div className="lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3">
            <div className="w-[30%] flex flex-col gap-3 lg:w-[30%] mb-7 lg:pl-0">
              ...
              <div className="flex flex-col gap-2">
                {["About", "Careers", "Affiliates"].map((e, i) => {
                  return (
                    <div
          ...
          <div className="lg:w-[50%] flex flex-wrap flex-row justify-between pl-3 lg:pl-5 gap-3">
            {FooterLink2.map((e, i) => {
              return (
                <div className="w-[35%] lg:w-[30%] mb-7 lg:pl-0" key={i}>
                  <h1 className=" text-richblack-50 font-semibold text-[16px]">
                    {e.title}
                  </h1>
                  <div className="flex flex-col gap-2 mt-2">
      ...
      <div className="flex flex-row items-center justify-between w-11/12 max-w-maxContent text-richblack-400 mx-auto pb-14 text-sm">
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
          ...
          <div className="flex items-center">
            <a
              href="https://www.linkedin.com/in/uzcoder-oo8"
            ...
            <a
              href="https://github.com/uzcoder-oo8"
              className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300"
              target="_blank"
              rel="noopener noreferrer"
            >
